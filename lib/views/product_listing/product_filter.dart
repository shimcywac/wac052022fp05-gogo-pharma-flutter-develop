...
import 'package:gogo_pharma/widgets/common_ListTile_checkbox.dart';
  ...
  void initialdata() {
    Future.microtask(() => {
          if (context.read<ProductProvider>().productFilter == null)
            {context.read<ProductProvider>().getProductFilters(context)}
          else
          ...
          actionList: [
            InkWell(
              ...
              onTap: () {
                maxValue = 0.0;
                minValue = 0.0;
                context.read<ProductProvider>().previousMaxValue = maxValue;
                context.read<ProductProvider>().previousMinValue = minValue;
...
//SWITHING FOR CATEGORY RESULT
  switching(ProductProvider _provider) {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: CommonTextFormField(
                onChanged: (searchkey) {
                  context.read<ProductProvider>().filterdata(searchkey);
                },
...
// PRICE SECTION
  Widget price(ProductProvider _provider) {
    return Padding(
