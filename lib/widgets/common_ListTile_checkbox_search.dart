...
class CommonListTileCheckBoxSearch extends StatefulWidget {
  final bool needTrailing;
  final int index;
  final String type;
  final List<Option>? list;
  const CommonListTileCheckBoxSearch({
    Key? key,
  ...
  @override
  State<CommonListTileCheckBoxSearch> createState() => _CommonListTileCheckBoxSearchState();
}

class _CommonListTileCheckBoxSearchState extends State<CommonListTileCheckBoxSearch> {
  @override
