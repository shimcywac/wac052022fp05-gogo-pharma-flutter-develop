...
class _CustomExpansionTileState extends State<CustomExpansionTile>
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child: widget.trailingExpand != null
          ? (_iconTurns.isCompleted
              ? widget.trailingExpanded
              : widget.trailingExpand)
          : Icon(
              Icons.expand_more,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        padding: widget.tilePadding ??
            EdgeInsets.symmetric(vertical: 19.h, horizontal: 18.w),
        child: Row(
          ...
          children: [
            ...
            widget.trailing ?? _buildTrailingIcon(context) ?? const SizedBox(),
          ],
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: <Widget>[
          InkWell(
            ...
            child: widget.headerChild ?? _customTile(),
          ),
          ClipRect(
            child: Align(
