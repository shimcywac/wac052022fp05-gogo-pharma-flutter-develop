...
class _LinearPercentIndicatorState extends State<CustomLinearPercentIndicator>
  ...
  void _checkIfNeedCancelAnimation(CustomLinearPercentIndicator oldWidget) {
  ...
  @override
  void didUpdateWidget(CustomLinearPercentIndicator oldWidget) {
...
//    ..strokeCap = StrokeCap.square
    ...
    drawDashedLine(canvas, size, paint);
  ...
  void drawDashedLine(Canvas canvas, Size size, Paint paint) {
