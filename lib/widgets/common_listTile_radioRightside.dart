...
class CommonListTileRadioListRight extends StatefulWidget {
  final List<SortFieldsOption>? sortFieldOptionsList;

  const CommonListTileRadioListRight({
    Key? key,
    required this.sortFieldOptionsList,
  }) : super(key: key);

  @override
  State<CommonListTileRadioListRight> createState() =>
      _CommonListTileRadioListState();
}

class _CommonListTileRadioListState
    extends State<CommonListTileRadioListRight> {
  late int selectedIndex;
  final ValueNotifier<int> _value = ValueNotifier<int>(0);
  @override
  Widget build(BuildContext context) {
    _value.value = context.read<ProductProvider>().selectedSortIndex;
                ...
                child: SizedBox(
                  child: ListTile(
                    onTap: () {
                      ...
                      context.read<ProductProvider>().storePreviousSortData(
